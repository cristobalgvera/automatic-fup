...
ErrorHandler_._ERROR_MESSAGE_TRANSLATIONS = {
  ...
  'Quy tắc định dạng có điều kiện không thể tham chiếu một trang tính khác.': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'vi',
  },
  ...
  'La regola di formattazione condizionale non può contenere un riferimento a un altro foglio.': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'it',
  },
  'La règle de mise en forme conditionnelle ne doit pas faire référence à une autre feuille.': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'fr',
  },
  'Une règle de mise en forme conditionnelle ne peut pas faire référence à une autre feuille.': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'fr_ca',
  },
  'Die Regel für eine bedingte Formatierung darf sich nicht auf ein anderes Tabellenblatt beziehen.': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'de',
  },
  'Правило условного форматирования не может ссылаться на другой лист.': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'ru',
  },
  '조건부 서식 규칙은 다른 시트를 참조할 수 없습니다.': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'ko',
  },
  '條件式格式規則無法參照其他工作表。': {
  ...
  '条件付き書式ルールで別のシートを参照することはできません。': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'ja',
  },
  'Pravidlo podmíněného formátu nemůže odkazovat na jiný list.': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'cs',
  },
  'Nosacījumformāta kārtulai nevar būt atsauce uz citu lapu.': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'lv',
  },
  'Pravidlo podmieneného formátovania nemôže odkazovať na iný hárok.': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'sk',
  },
  ...
  'Ehdollinen muotoilusääntö ei voi viitata toiseen taulukkoon.': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'fi',
  },
  กฎการจัดรูปแบบตามเงื่อนไขอ้างอิงแผ่นงานอื่นไม่ได้: {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'th',
  },
  'Reguła formatowania warunkowego nie może odwoływać się do innego arkusza.': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'pl',
  },
  ...
  'Villkorsstyrd formateringsregel får inte referera till ett annat arbetsblad.': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'sv',
  },
  'La regla de format condicional no pot fer referència a un altre full.': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'ca',
  },
  'A feltételes formázási szabály nem tud másik munkalapot meghívni.': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'hu',
  },
  'A regra de formatação condicional não pode fazer referência a uma página diferente.': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'pt',
  },
  'Правило умовного форматування не може посилатися на інший аркуш.': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'uk',
  },
  'لا يمكن أن تشير الصيغة الشرطية إلى ورقة مختلفة.': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'ar_sa',
  },
  'Ο κανόνας μορφής υπό συνθήκες δεν μπορεί να αναφέρεται σε διαφορετικό φύλλο.': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'el',
  },
  ...
  'Koşullu biçimlendirme kuralı farklı bir sayfaya başvuramaz.': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'tr',
  },
  ...
  'כלל של פורמט מותנה לא יכול לכלול הפניה לגיליון אחר.': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'iw',
  },
  ...
  'Sąlyginio formato taisyklė negali nurodyti kito lapo.': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'lt',
  },
  'Regula cu format condiționat nu poate face referire la altă foaie.': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'ro',
  },
  ...
  'Правило за условно обликовање не може да указује на другу табелу.': {
    ref: NORMALIZED_ERRORS.CONDITIONNAL_RULE_REFERENCE_DIF_SHEET,
    locale: 'sr',
  },
  ...
  'Une erreur est survenue sur le serveur. Nous vous prions de nous en excuser et vous invitons à réessayer ultérieurement.': {
    ref: NORMALIZED_ERRORS.SERVER_ERROR_RETRY_LATER,
    locale: 'fr',
  },
  'Xin lỗi bạn, máy chủ đã gặp lỗi. Vui lòng chờ một lát và thử lại.': {
    ref: NORMALIZED_ERRORS.SERVER_ERROR_RETRY_LATER,
    locale: 'vi',
  },
  ...
  'Lo sentimos, se produjo un error en el servidor. Aguarde un momento e inténtelo de nuevo.': {
    ref: NORMALIZED_ERRORS.SERVER_ERROR_RETRY_LATER,
    locale: 'es_419',
  },
  'ขออภัย มีข้อผิดพลาดของเซิร์ฟเวอร์เกิดขึ้น โปรดรอสักครู่แล้วลองอีกครั้ง': {
    ref: NORMALIZED_ERRORS.SERVER_ERROR_RETRY_LATER,
    locale: 'th',
  },
  '很抱歉，伺服器發生錯誤，請稍後再試。': {
  ...
  'Sajnáljuk, szerverhiba történt. Kérjük, várjon egy kicsit, majd próbálkozzon újra.': {
    ref: NORMALIZED_ERRORS.SERVER_ERROR_RETRY_LATER,
    locale: 'hu',
  },
  'Ett serverfel uppstod. Vänta lite och försök igen.': {
    ref: NORMALIZED_ERRORS.SERVER_ERROR_RETRY_LATER,
    locale: 'sv',
  },
  'A apărut o eroare de server. Așteptați puțin și încercați din nou.': {
    ref: NORMALIZED_ERRORS.SERVER_ERROR_RETRY_LATER,
    locale: 'ro',
  },
  ...
  'S-a înregistrat o eroare de server: DEADLINE_EXCEEDED': {
    ref: NORMALIZED_ERRORS.SERVER_ERROR_DEADLINE_EXCEEDED,
    locale: 'ro',
  },
  'عذرًا، حدث خطأ في الخادم: DEADLINE_EXCEEDED': {
    ref: NORMALIZED_ERRORS.SERVER_ERROR_DEADLINE_EXCEEDED,
    locale: 'ar',
  },
  ...
  'К сожалению, произошла ошибка сервера: DEADLINE_EXCEEDED': {
    ref: NORMALIZED_ERRORS.SERVER_ERROR_DEADLINE_EXCEEDED,
    locale: 'ru',
  },
  'Spiacenti, si è verificato un errore del server: DEADLINE_EXCEEDED': {
    ref: NORMALIZED_ERRORS.SERVER_ERROR_DEADLINE_EXCEEDED,
    locale: 'it',
  },
  'מצטערים, אירעה שגיאת שרת: DEADLINE_EXCEEDED': {
    ref: NORMALIZED_ERRORS.SERVER_ERROR_DEADLINE_EXCEEDED,
    locale: 'he',
  },
  'Tyvärr uppstod ett serverfel: DEADLINE_EXCEEDED': {
    ref: NORMALIZED_ERRORS.SERVER_ERROR_DEADLINE_EXCEEDED,
    locale: 'sv',
  },
  'ขออภัย เกิดข้อผิดพลาดของเซิร์ฟเวอร์: DEADLINE_EXCEEDED': {
    ref: NORMALIZED_ERRORS.SERVER_ERROR_DEADLINE_EXCEEDED,
    locale: 'th',
  },
  'Sajnáljuk, szerverhiba történt: DEADLINE_EXCEEDED': {
    ref: NORMALIZED_ERRORS.SERVER_ERROR_DEADLINE_EXCEEDED,
    locale: 'hu',
  },
  ...
  'Xin lỗi bạn, máy chủ đã gặp lỗi: DEADLINE_EXCEEDED': {
    ref: NORMALIZED_ERRORS.SERVER_ERROR_DEADLINE_EXCEEDED,
    locale: 'vi',
  },
  ...
  'Cần được cho phép để thực hiện tác vụ đó. Hãy chạy lại tập lệnh để cho phép tác vụ.': {
    ref: NORMALIZED_ERRORS.AUTHORIZATION_REQUIRED,
    locale: 'vi',
  },
  'É necessária autorização para executar esta ação. Execute o script novamente para autorizar a ação.': {
    ref: NORMALIZED_ERRORS.AUTHORIZATION_REQUIRED,
    locale: 'pt',
  },
  ...
  'É necessária autorização para efetuar esta ação.': {
    ref: NORMALIZED_ERRORS.AUTHORIZATION_REQUIRED,
    locale: 'pt',
  },
  ...
  'Sınır Aşıldı: İleti Başına E-posta Alıcısı.': {
    ref: NORMALIZED_ERRORS.LIMIT_EXCEEDED_MAX_RECIPIENTS_PER_MESSAGE,
    locale: 'tr',
  },
  'Đã vượt quá giới hạn: Người nhận email trên mỗi thư.': {
    ref: NORMALIZED_ERRORS.LIMIT_EXCEEDED_MAX_RECIPIENTS_PER_MESSAGE,
    locale: 'vi',
  },
  'Límite excedido: Destinatarios de correo electrónico por mensaje.': {
    ref: NORMALIZED_ERRORS.LIMIT_EXCEEDED_MAX_RECIPIENTS_PER_MESSAGE,
    locale: 'es',
  },
  ...
  'Límite Excedido: Tamaño del cuerpo del mensaje.': {
    ref: NORMALIZED_ERRORS.LIMIT_EXCEEDED_EMAIL_BODY_SIZE,
    locale: 'es_PE',
  },
  ...
  'Límite excedido: Tamaño total de los archivos adjuntos del correo electrónico.': {
    ref: NORMALIZED_ERRORS.LIMIT_EXCEEDED_EMAIL_TOTAL_ATTACHMENTS_SIZE,
    locale: 'es',
  },
  ...
  'Estás intentando editar una celda o un objeto protegidos. Ponte en contacto con el propietario de la hoja de cálculo para desprotegerla si es necesario modificarla.': {
    ref: NORMALIZED_ERRORS.TRYING_TO_EDIT_PROTECTED_CELL,
    locale: 'es',
  },
  "Vous tentez de modifier une cellule ou un objet protégés. Si vous avez besoin d'effectuer cette modification, demandez au propriétaire de la feuille de calcul de supprimer la protection.": {
    ref: NORMALIZED_ERRORS.TRYING_TO_EDIT_PROTECTED_CELL,
    locale: 'fr',
  },
  'Эта область защищена. Чтобы изменить ее, обратитесь к владельцу таблицы.': {
    ref: NORMALIZED_ERRORS.TRYING_TO_EDIT_PROTECTED_CELL,
    locale: 'ru',
  },
  ...
  'Você está tentando editar uma célula ou um objeto protegido. Se precisar editar, entre em contato com o proprietário da planilha para remover a proteção.': {
    ref: NORMALIZED_ERRORS.TRYING_TO_EDIT_PROTECTED_CELL,
    locale: 'pt',
  },
  'Покушавате да измените заштићену ћелију или објекат. Контактирајте власника табеле да уклони заштиту ако треба да унесете измене.': {
    ref: NORMALIZED_ERRORS.TRYING_TO_EDIT_PROTECTED_CELL,
    locale: 'sr',
  },
  ...
  'As coordenadas do intervalo estão fora das dimensões da página.': {
    ref: NORMALIZED_ERRORS.RANGE_COORDINATES_ARE_OUTSIDE_SHEET_DIMENSIONS,
    locale: 'pt',
  },
  'Tọa độ của dải ô nằm ngoài kích thước của trang tính.': {
    ref: NORMALIZED_ERRORS.RANGE_COORDINATES_ARE_OUTSIDE_SHEET_DIMENSIONS,
    locale: 'vi',
  },
  ...
  'Không tìm thấy mục nào có ID đã cung cấp hoặc bạn không có quyền truy cập vào mục đó.': {
    ref: NORMALIZED_ERRORS.NO_ITEM_WITH_GIVEN_ID_COULD_BE_FOUND,
    locale: 'vi',
  },
  'No se ha encontrado ningún elemento con el ID proporcionado o no tienes permiso para acceder a él.': {
    ref: NORMALIZED_ERRORS.NO_ITEM_WITH_GIVEN_ID_COULD_BE_FOUND,
    locale: 'es',
  },
  'No se ha encontrado ningún elemento con la ID proporcionada o no tienes permiso para acceder a él.': {
    ref: NORMALIZED_ERRORS.NO_ITEM_WITH_GIVEN_ID_COULD_BE_FOUND,
    locale: 'es_419',
  },
  ...
  'Det gick inte att hitta någon post med angivet ID eller så saknar du behörighet för att få åtkomst till den.': {
    ref: NORMALIZED_ERRORS.NO_ITEM_WITH_GIVEN_ID_COULD_BE_FOUND,
    locale: 'sv',
  },
  ...
  "Impossible de trouver l'élément correspondant à cet identifiant. Vous n'êtes peut-être pas autorisé à y accéder.": {
    ref: NORMALIZED_ERRORS.NO_ITEM_WITH_GIVEN_ID_COULD_BE_FOUND,
    locale: 'fr',
  },
  "No s'ha trobat cap element amb aquest identificador o no teniu permís per accedir-hi.": {
    ref: NORMALIZED_ERRORS.NO_ITEM_WITH_GIVEN_ID_COULD_BE_FOUND,
    locale: 'ca',
  },
  'Элемент с заданным кодом не найден или у вас нет прав доступа к нему.': {
    ref: NORMALIZED_ERRORS.NO_ITEM_WITH_GIVEN_ID_COULD_BE_FOUND,
    locale: 'ru',
  },
  'Nebyly nalezeny žádné položky se zadaným ID nebo nemáte oprávnění k nim přistupovat.': {
    ref: NORMALIZED_ERRORS.NO_ITEM_WITH_GIVEN_ID_COULD_BE_FOUND,
    locale: 'cs',
  },
  ...
  '指定された ID のアイテムは見つからなかったか、アクセスする権限がありません。': {
    ref: NORMALIZED_ERRORS.NO_ITEM_WITH_GIVEN_ID_COULD_BE_FOUND,
    locale: 'ja',
  },
  'Не вдалося знайти елемент із зазначеним ідентифікатором. Або у вас немає дозволу на доступ до нього.': {
    ref: NORMALIZED_ERRORS.NO_ITEM_WITH_GIVEN_ID_COULD_BE_FOUND,
    locale: 'uk',
  },
  'Verilen kimliğe sahip öğe bulunamadı veya bu öğeye erişme iznine sahip değilsiniz.': {
    ref: NORMALIZED_ERRORS.NO_ITEM_WITH_GIVEN_ID_COULD_BE_FOUND,
    locale: 'tr',
  },
  ...
  'Bạn không có quyền truy cập tài liệu yêu cầu.': {
    ref: NORMALIZED_ERRORS.NO_PERMISSION_TO_ACCESS_THE_REQUESTED_DOCUMENT,
    locale: 'vi',
  },
  ...
  "Vous n'avez pas l'autorisation d'accéder au document demandé.": {
    ref: NORMALIZED_ERRORS.NO_PERMISSION_TO_ACCESS_THE_REQUESTED_DOCUMENT,
    locale: 'fr',
  },
  ...
  'Impossible de communiquer pour déclencher le service': {
    ref: NORMALIZED_ERRORS.UNABLE_TO_TALK_TO_TRIGGER_SERVICE,
    locale: 'fr',
  },
  'Không thể trao đổi với người môi giới để kích hoạt dịch vụ': {
    ref: NORMALIZED_ERRORS.UNABLE_TO_TALK_TO_TRIGGER_SERVICE,
    locale: 'vi',
  },
  'No es posible ponerse en contacto con el servicio de activación.': {
    ref: NORMALIZED_ERRORS.UNABLE_TO_TALK_TO_TRIGGER_SERVICE,
    locale: 'es',
  },
  無法與觸發服務聯絡: {
  ...
  'No se admite la operación de Gmail.': {
    ref: NORMALIZED_ERRORS.GMAIL_OPERATION_NOT_ALLOWED,
    locale: 'es',
  },
  'Opération non autorisée dans Gmail.': {
    ref: NORMALIZED_ERRORS.GMAIL_OPERATION_NOT_ALLOWED,
    locale: 'fr',
  },
  ...
  "L'opération sur Gmail a été annulée. : Label name exists or conflicts": {
    ref: NORMALIZED_ERRORS.LABEL_NAME_EXISTS_OR_CONFLICTS,
    locale: 'fr',
  },
  ...
  'Có quá nhiều thao tác LockService trên cùng một tập lệnh.': {
    ref: NORMALIZED_ERRORS.TOO_MANY_LOCK_OPERATIONS,
    locale: 'vi',
  },
