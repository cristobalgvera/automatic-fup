 ...
 */
declare function urlFetchWithExpBackOff(
  url: string,
  params?: any,
 ...
 */
declare function getNormalizedError(
 ...
 */
declare function getErrorLocale(localizedErrorMessage: string): string | '';
declare namespace NORMALIZED_ERRORS {
