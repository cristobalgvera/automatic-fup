 ...
 */
declare function getDatabaseByUrl(
  url: string,
  optSecret?: string
): FirebaseApp_.Base;
/**
 ...
 */
declare function encodeAsFirebaseKey(string: string): string;
/**
 ...
 */
declare function decodeFirebaseKey(string: string): string;
/**
 ...
 */
declare function signInWithIdp(firebaseConfig: object, idToken: string): object;
